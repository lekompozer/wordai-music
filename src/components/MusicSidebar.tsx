        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <div className="flex flex-col items-end gap-1.5" style={{ WebkitAppRegion: 'no-drag' } as React.CSSProperties}>
                        <button
                            ...
                            <div className="flex gap-1">
                                {(['vi', 'en'] as const).map(l => (
                                    <button
                                        ...
                                        style={shortsLang === l ? { background: 'linear-gradient(135deg, #4338ca 0%, #1d4ed8 100%)', WebkitAppRegion: 'no-drag' } as React.CSSProperties : { WebkitAppRegion: 'no-drag' } as React.CSSProperties}
